  ...
  constructor(bot) {
    super(bot, {
      ...
      async run(message, args) {
        const rlp1Embed = new Discord.MessageEmbed(message)
        .setColor('#0099ff')
